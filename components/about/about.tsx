...
export default function About() {
  return (
    <section className="container">
      ...
      <TypographyP>
        In the early 2000s, I took my first steps into the world of web
        development by creating a website that showcased the local bands in the
        coastal scene of Sao Paulo. Skip ahead to today, and I&#39;m having a
        lot of fun building some seriously awesome content for the web.
      </TypographyP>
      <TypographyP>
        ...
        world of Next.js, an interesting mix of React and Node.js that&#39;s a
        paradise for a full stack dev.
      </TypographyP>
      <TypographyP>
